...
- `obj` **[Object](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object)**
  ...
  - `obj.keepBond` **[boolean](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Boolean)** This flag indicates whether the bond information should be kept or removed after an upgrade of the Application (Android only) - defaults to `false`
