...
-   `obj` **[Object](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object)** 
    ...
    -   `obj.keepBond` **[Boolean](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Boolean)** This flag indicates whether the bond information should be kept or removed after an upgrade of the Application (Android only) (optional, default `false`)
    -   `obj.alternativeAdvertisingNameEnabled` **[Boolean](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Boolean)** Send unique name to device before it is switched into bootloader mode (iOS only) (optional, default `true`)
    -   `obj.forceScanForNewAddress` **[Boolean](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Boolean)** When this is set to true, the Legacy Buttonless Service will scan for the device advertising with an incremented MAC address (Android only) (optional, default `false`)
